...
- [x] 1단계 프롬프트에 raw 링크 실패 시 재시도할 GitHub blob 대체 링크를 미리 포함 — 사람 개입(본문 복사) 없이 AI가 먼저 자체 재시도하도록 개선 (2026-08-28)
- [x] 1단계 프롬프트에 3번째 폴백으로 공개 Notion 페이지 링크 추가 (GitHub 도메인 자체가 막히는 경우 대비, 서로 다른 도메인) — GitHub Pages로 .md 직접 서빙은 Jekyll 처리로 404 발생해 폐기, 대신 Notion 링크 채택 (2026-08-28)
